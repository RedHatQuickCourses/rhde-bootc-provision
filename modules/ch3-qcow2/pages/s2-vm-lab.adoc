...
You cannot perform them with bootc image builder, you must either use another day-1 customization technology, or have the network settings hard-coded in your bootc container image.

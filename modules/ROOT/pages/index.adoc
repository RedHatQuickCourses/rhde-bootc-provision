...
IMPORTANT: Red Hat associates must enroll using its https://training-lms.redhat.com/sso/saml/auth/rhlpint?RelayState=deeplinkoffering%3D85515489[Red Hat University] entry, and Red Hat Partners must enroll using its https://training-lms.redhat.com/sso/saml/auth/rhopen?RelayState=deeplinkoffering%3D85515707[Red Hat Partner Connect] entry.

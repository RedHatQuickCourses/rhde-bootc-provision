= Provisioning Red Hat Device Edge Systems with Image Mode for RHEL
:navtitle: Home
...
. https://redhatquickcourses.github.io/rhde-bootc-update/[Updating and Repurposing Red Hat Device Edge Systems with Image Mode for RHEL] (follow-up course)

IMPORTANT: Red Hat associates must enroll using the https://training-lms.redhat.com/sso/saml/auth/rhlpint?RelayState=deeplinkoffering%3D85515489[Red Hat Learning Portal], and Red Hat Partners must enroll using the https://training-lms.redhat.com/sso/saml/auth/rhopen?RelayState=deeplinkoffering%3D85515707[Red Hat Partner Connect].
...
IMPORTANT: The image mode with Red Hat Device Edge quick courses use ROLE for their virtual classroom labs only, and hosts course materials outside of ROLE, as GitHub pages.

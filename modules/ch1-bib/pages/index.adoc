...
This tool solves the issue of being able to provision systems using system images created with image mode for RHEL, that is, bootc container images, at scale and by using workflows that look similar to provisioning systems using package mode for RHEL.
...
Provisioning systems from such images requires no knowledge of containers or image mode.
This enables operation technology (OT) personnel to provision edge systems using image mode for RHEL without a steep learning curve.

...
.. If you think that your clone may be outdated, because you started the first course before the remaining courses were available, you can just update your local clone.
+
[source,subs="verbatim,quotes"]
--
